...
router.post('/edit/:pid', (req, res) => {
        ...
        address, city, website, username, password,password2,date} = req.body;
            ...
            Artisan.updateOne({_id:req.params.pid}, {$set:{cName, cNumber,cEmail, bName, cacStatus, title, 
                staffStrength, address, city, website, username, password,password2,date}}, (err, record) => {
                if (err) {
